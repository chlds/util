...
signed char *(__cdecl cvtxt_february_in_ll(signed(args/* carry over */),signed(argp/* di */)));
signed char *(__cdecl cvtxt_march_in_ll(signed(args/* carry over */),signed(argp/* di */)));
signed char *(__cdecl cvtxt_april_in_ll(signed(args/* carry over */),signed(argp/* di */)));
signed char *(__cdecl cvtxt_may_in_ll(signed(args/* carry over */),signed(argp/* di */)));
signed char *(__cdecl cvtxt_june_in_ll(signed(args/* carry over */),signed(argp/* di */)));
signed char *(__cdecl cvtxt_july_in_ll(signed(args/* carry over */),signed(argp/* di */)));
...
signed char *(__cdecl cvtxt_october_in_ll(signed(args/* carry over */),signed(argp/* di */)));
signed char *(__cdecl cvtxt_november_in_ll(signed(args/* carry over */),signed(argp/* di */)));
signed char *(__cdecl cvtxt_december_in_ll(signed(args/* carry over */),signed(argp/* di */)));
...
signed(__cdecl convmer(signed(arg),signed char(**argp)));
signed(__cdecl cfmmer_period(signed char(**argp),signed(__cdecl*f)(signed char(**argp))));
signed(__cdecl cfmmer_rr_rr(signed char **argp));
...
signed(__cdecl cvhr_txt(signed char *argp));
signed(__cdecl cvmn_txt(signed char *argp));
signed(__cdecl cvtd_vec_extras(signed(arg),signed char(**argp),signed(__cdecl*f)(signed(arg),signed char(**argp))));
...
signed(__cdecl cvtd_vec_rrrr_r(signed(arg),signed char(**argp)));
...
signed(__cdecl cue_rrrrr(signed char(**sym),signed char(*argp)));
...
signed(__cdecl cueno(signed char *argp));
...
signed char *(__cdecl xttt(signed char(*param),signed char(*path),signed(argt),signed(argk),signed char *(__cdecl*f)(signed(args/* fd */),signed(argt),signed(argk))));
signed char *(__cdecl xtt_w(signed char(*param),signed short(*path),signed(argt),signed char *(__cdecl*f)(signed(args/* fd */),signed(argt))));
...
signed char *(__cdecl rdtxt_xe_w(signed short(*argp),signed(argt),signed(argk/* seek */)));
signed char *(__cdecl rdtxt_xe_b(signed char(*argp),signed(argt),signed(argk/* seek */)));
...
signed char *(__cdecl /* __attribute__((ms_abi)) */ catt(signed char *argp,...));
/* Concatenate to the terminating null pointer */
...
signed *(__cdecl catnir(signed(*args),signed(argp)));
signed *(__cdecl catnir_xe(signed(args),signed(*argp)));
signed *(__cdecl cathir_xe(signed(args),signed(*argp)));
signed *(__cdecl cathir(signed(*args),signed(argp)));
signed short *(__cdecl catnis(signed short(*args),signed(argp)));
signed short *(__cdecl catnis_xe(signed(args),signed short(*argp)));
signed short *(__cdecl cathis_xe(signed(args),signed short(*argp)));
signed short *(__cdecl cathis(signed short(*args),signed(argp)));
...
signed char *(__cdecl clih_i_rrrr(signed(arg),signed char(*argp)));
signed char *(__cdecl clih_i_rrr(signed char *argp));
...
signed(__cdecl calc_25x(signed(arg)));
signed(__cdecl calc_26x(signed(arg)));
signed(__cdecl calc_27x(signed(arg)));
signed(__cdecl calc_28x(signed(arg)));
signed(__cdecl calc_29x(signed(arg)));
signed(__cdecl calc_30x(signed(arg)));
signed(__cdecl calc_31x(signed(arg)));
/* Calculate */
