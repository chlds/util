...
static signed char WEEK_OLD_IN_EN[] = ("Week");
static signed char WEEK_DECOR_IN_EN[] = {
'W',0xE1,0xB4,0x87,0xE1,0xB4,0x87,0xE1,0xB4,0x8B,0x00,
};

static signed char WEEK_S_OLD_IN_EN[] = ("week");
static signed char WEEK_S_DECOR_IN_EN[] = {
0xE1,0xB4,0xA1,0xE1,0xB4,0x87,0xE1,0xB4,0x87,0xE1,0xB4,0x8B,0x00,
};

static signed char DAY_LATN_S_IN_EN[] = ("day");
static signed char DAY_LATN_S_LSC_IN_EN[] = {
0xE1,0xB4,0x85,0xE1,0xB4,0x80,0xCA,0x8F,0x00,
};

static signed char OF_LATN_S_IN_EN[] = ("of");
static signed char OF_LATN_S_LSC_IN_EN[] = {
