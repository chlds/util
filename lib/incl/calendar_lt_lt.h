...
static signed char CALENDAR_LITHUANIAN_IN_LT_LT[] = ("Lithuanian");
static signed char CALENDAR_LLSC_LITHUANIAN_IN_LT_LT[] = {
'L',0xC9,0xAA,0xE1,0xB4,0x9B,0xCA,0x9C,0xE1,0xB4,0x9C,0xE1,0xB4,0x80,0xC9,0xB4,0xC9,0xAA,0xE1,0xB4,0x80,0xC9,0xB4,0x00,
};
