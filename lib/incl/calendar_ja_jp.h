...
static signed char CALENDAR_IN_JA_JP[] = ("Japanese");
static signed char CALENDAR_LLSC_IN_JA_JP[] = {
0xE1,0xB4,0x8A,0xE1,0xB4,0x80,0xE1,0xB4,0x98,0xE1,0xB4,0x80,0xC9,0xB4,0xE1,0xB4,0x87,0xEA,0x9C,0xB1,0xE1,0xB4,0x87,0x00,
};
static signed char CALENDAR_NATIVE_IN_JA_JP[] = {
0xE6,0x97,0xA5,0xE6,0x9C,0xAC,0xE8,0xAA,0x9E,0x00,
};
static signed char *CALENDAR_LLSC_NATIVE_IN_JA_JP = (CALENDAR_NATIVE_IN_JA_JP);
...
0xE6,0x97,0xA9,0xE6,0x9C,0x9D,0x00,
};
static signed char DVE_MORNING_IN_JA_JP[] = {
0xE6,0x9C,0x9D,0x00,
};
static signed char DVE_LATE_MORNING_IN_JA_JP[] = {
0xE6,0x98,0xBC,0xE5,0x89,0x8D,0x00,
};
static signed char DVE_NOON_IN_JA_JP[] = {
0xE6,0xAD,0xA3,0xE5,0x8D,0x88,0x00,
};
static signed char DVE_EARLY_AFTERNOON_IN_JA_JP[] = {
0xE6,0x98,0xBC,0xE4,0xB8,0x8B,0xE3,0x81,0x8C,0xE3,0x82,0x8A,0x00,
};
static signed char DVE_AFTERNOON_IN_JA_JP[] = {
0xE5,0x8D,0x88,0xE5,0xBE,0x8C,0x00,
};
static signed char DVE_EVENING_IN_JA_JP[] = {
0xE5,0xA4,0x95,0xE6,0x96,0xB9,0x00,
};
static signed char DVE_NIGHT_IN_JA_JP[] = {
0xE5,0xA4,0x9C,0x00,
};
...
static signed char SU_JA_JP[] = {
0xE3,0x88,0xB0,0x00,
};
static signed char MO_JA_JP[] = {
0xE3,0x88,0xAA,0x00,
};
static signed char TU_JA_JP[] = {
0xE3,0x88,0xAB,0x00,
};
static signed char WE_JA_JP[] = {
0xE3,0x88,0xAC,0x00,
};
static signed char TH_JA_JP[] = {
0xE3,0x88,0xAD,0x00,
};
static signed char FR_JA_JP[] = {
0xE3,0x88,0xAE,0x00,
};
static signed char SA_JA_JP[] = {
0xE3,0x88,0xAF,0x00,
};
static signed char *(CALENDAR_W_IN_JA_JP[]) = {
SU_JA_JP,
MO_JA_JP,
TU_JA_JP,
WE_JA_JP,
