...
0xEA,0x9C,0xB1,0xE1,0xB4,0x87,0xCA,0x80,0xCA,0x99,0xC9,0xAA,0xE1,0xB4,0x80,0xC9,0xB4,0x00,
};
static signed char CALENDAR_NATIVE_IN_SR_CYRL_RS[] = {
0xD1,0x81,0xD1,0x80,0xD0,0xBF,0xD1,0x81,0xD0,0xBA,0xD0,0xB8,\
' ',\
0xD1,0x98,0xD0,0xB5,0xD0,0xB7,0xD0,0xB8,0xD0,0xBA,\
0x00,
};
static signed char *CALENDAR_LLSC_NATIVE_IN_SR_CYRL_RS = (CALENDAR_NATIVE_IN_SR_CYRL_RS);
...
static signed char JAN_SR_CYRL_RS[] = {
0xD1,0x98,0xD0,0xB0,0xD0,0xBD,0x00,
};
static signed char FEB_SR_CYRL_RS[] = {
0xD1,0x84,0xD0,0xB5,0xD0,0xB1,0x00,
};
static signed char MAR_SR_CYRL_RS[] = {
0xD0,0xBC,0xD0,0xB0,0xD1,0x80,0x00,
};
static signed char APR_SR_CYRL_RS[] = {
0xD0,0xB0,0xD0,0xBF,0xD1,0x80,0x00,
};
static signed char AUG_SR_CYRL_RS[] = {
0xD0,0xB0,0xD0,0xB2,0xD0,0xB3,0x00,
};
static signed char SEP_SR_CYRL_RS[] = {
0xD1,0x81,0xD0,0xB5,0xD0,0xBF,0x00,
};
static signed char OCT_SR_CYRL_RS[] = {
0xD0,0xBE,0xD0,0xBA,0xD1,0x82,0x00,
};
static signed char NOV_SR_CYRL_RS[] = {
0xD0,0xBD,0xD0,0xBE,0xD0,0xB2,0x00,
};
static signed char DEC_SR_CYRL_RS[] = {
0xD0,0xB4,0xD0,0xB5,0xD1,0x86,0x00,
};
static signed char *(CALENDAR_MON_IN_SR_CYRL_RS[]) = {
"",
JAN_SR_CYRL_RS,
FEB_SR_CYRL_RS,
MAR_SR_CYRL_RS,
