...
0xCA,0x9C,0xE1,0xB4,0x9C,0xC9,0xB4,0xC9,0xA2,0xE1,0xB4,0x80,0xCA,0x80,0xC9,0xAA,0xE1,0xB4,0x80,0xC9,0xB4,0x00,
};
static signed char CALENDAR_NATIVE_IN_HU_HU[] = ("magyar nyelv");
static signed char *CALENDAR_LLSC_NATIVE_IN_HU_HU = (CALENDAR_NATIVE_IN_HU_HU);
