...
0xE1,0xB4,0x9B,0xE1,0xB4,0x9C,0xCA,0x80,0xE1,0xB4,0x8B,0xC9,0xAA,0xEA,0x9C,0xB1,0xCA,0x9C,0x00,
};
static signed char CALENDAR_NATIVE_IN_TR_TR[] = {
'T',0xC3,0xBC,'r','k',0xC3,0xA7,'e',\
' ','/',' ',\
'T',0xC3,0xBC,'r','k',' ','d','i','l','i',\
0x00,
};
static signed char *CALENDAR_LLSC_NATIVE_IN_TR_TR = (CALENDAR_NATIVE_IN_TR_TR);
