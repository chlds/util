...
static signed char CALENDAR_NATIVE_IN_QU[] = {
'R',0xE1,0xB4,0x9C,0xC9,0xB4,0xE1,0xB4,0x80,0x20,
0xEA,0x9C,0xB1,0xC9,0xAA,0xE1,0xB4,0x8D,0xC9,0xAA,0x00,
};
static signed char *CALENDAR_LLSC_NATIVE_IN_QU = ("Runa simi");
