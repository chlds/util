...
static signed char CALENDAR_IN_TH_TH[] = ("Central Thai / Siamese / Thai");
static signed char CALENDAR_LLSC_IN_TH_TH[] = {
0xE1,0xB4,0x84,0xE1,0xB4,0x87,0xC9,0xB4,0xE1,0xB4,0x9B,0xCA,0x80,0xE1,0xB4,0x80,0xCA,0x9F,' ',\
0xE1,0xB4,0x9B,0xCA,0x9C,0xE1,0xB4,0x80,0xC9,0xAA,\
' ','/',' ',\
0xEA,0x9C,0xB1,0xC9,0xAA,0xE1,0xB4,0x80,0xE1,0xB4,0x8D,0xE1,0xB4,0x87,0xEA,0x9C,0xB1,0xE1,0xB4,0x87,\
' ','/',' ',\
0xE1,0xB4,0x9B,0xCA,0x9C,0xE1,0xB4,0x80,0xC9,0xAA,\
0x00,
};
static signed char CALENDAR_NATIVE_IN_TH_TH[] = {
0xE0,0xB8,0xA0,0xE0,0xB8,0xB2,0xE0,0xB8,0xA9,0xE0,0xB8,0xB2,0xE0,0xB9,0x84,0xE0,0xB8,0x97,0xE0,0xB8,0xA2,0x00,
};
static signed char *CALENDAR_LLSC_NATIVE_IN_TH_TH = (CALENDAR_NATIVE_IN_TH_TH);
...
static signed char JAN_TH_TH[] = {
0xE0,0xB8,0xA1,'.',0xE0,0xB8,0x84,'.',0x00,
};
static signed char FEB_TH_TH[] = {
0xE0,0xB8,0x81,'.',0xE0,0xB8,0x9E,'.',0x00,
};
static signed char MAR_TH_TH[] = {
0xE0,0xB8,0xA1,0xE0,0xB8,0xB5,'.',0xE0,0xB8,0x84,'.',0x00,
};
static signed char APR_TH_TH[] = {
0xE0,0xB9,0x80,0xE0,0xB8,0xA1,'.',0xE0,0xB8,0xA2,'.',0x00,
};
static signed char MAY_ABBREV_TH_TH[] = {
0xE0,0xB8,0x9E,'.',0xE0,0xB8,0x84,'.',0x00,
};
static signed char JUN_TH_TH[] = {
0xE0,0xB8,0xA1,0xE0,0xB8,0xB4,'.',0xE0,0xB8,0xA2,'.',0x00,
};
static signed char JUL_TH_TH[] = {
0xE0,0xB8,0x81,'.',0xE0,0xB8,0x84,'.',0x00,
};
static signed char AUG_TH_TH[] = {
0xE0,0xB8,0xAA,'.',0xE0,0xB8,0x84,'.',0x00,
};
static signed char SEP_TH_TH[] = {
0xE0,0xB8,0x81,'.',0xE0,0xB8,0xA2,'.',0x00,
};
static signed char OCT_TH_TH[] = {
0xE0,0xB8,0x95,'.',0xE0,0xB8,0x84,'.',0x00,
};
static signed char NOV_TH_TH[] = {
0xE0,0xB8,0x9E,'.',0xE0,0xB8,0xA2,'.',0x00,
};
static signed char DEC_TH_TH[] = {
0xE0,0xB8,0x98,'.',0xE0,0xB8,0x84,'.',0x00,
};
static signed char *(CALENDAR_MON_IN_TH_TH[]) = {
"",
JAN_TH_TH,
FEB_TH_TH,
MAR_TH_TH,
