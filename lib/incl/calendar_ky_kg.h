...
0xE1,0xB4,0x8B,0xCA,0x8F,0xCA,0x80,0xC9,0xA2,0xCA,0x8F,0xE1,0xB4,0xA2,0x00,
};
...
static signed char JAN_KY_KG[] = {
0xD1,0x8F,0xD0,0xBD,0xD0,0xB2,'.',0x00,
};
static signed char FEB_KY_KG[] = {
0xD1,0x84,0xD0,0xB5,0xD0,0xB2,'.',0x00,
};
static signed char MAR_KY_KG[] = {
0xD0,0xBC,0xD0,0xB0,0xD1,0x80,'.',0x00,
};
static signed char APR_KY_KG[] = {
0xD0,0xB0,0xD0,0xBF,0xD1,0x80,'.',0x00,
};
static signed char JUN_KY_KG[] = {
0xD0,0xB8,0xD1,0x8E,0xD0,0xBD,'.',0x00,
};
static signed char JUL_KY_KG[] = {
0xD0,0xB8,0xD1,0x8E,0xD0,0xBB,'.',0x00,
};
static signed char AUG_KY_KG[] = {
0xD0,0xB0,0xD0,0xB2,0xD0,0xB3,'.',0x00,
};
static signed char SEP_KY_KG[] = {
0xD1,0x81,0xD0,0xB5,0xD0,0xBD,'.',0x00,
};
static signed char OCT_KY_KG[] = {
0xD0,0xBE,0xD0,0xBA,0xD1,0x82,'.',0x00,
};
static signed char NOV_KY_KG[] = {
0xD0,0xBD,0xD0,0xBE,0xD1,0x8F,'.',0x00,
};
static signed char DEC_KY_KG[] = {
0xD0,0xB4,0xD0,0xB5,0xD0,0xBA,'.',0x00,
};
static signed char *(CALENDAR_MON_IN_KY_KG[]) = {
"",
JAN_KY_KG,
FEB_KY_KG,
MAR_KY_KG,
