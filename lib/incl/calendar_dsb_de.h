...
0xCA,0x9F,0xE1,0xB4,0x8F,0xE1,0xB4,0xA1,0xE1,0xB4,0x87,0xCA,0x80,\
' ',0xEA,0x9C,0xB1,0xE1,0xB4,0x8F,0xCA,0x80,0xCA,0x99,0xC9,0xAA,0xE1,0xB4,0x80,0xC9,0xB4,\
0x00,
};
static signed char CALENDAR_NATIVE_IN_DSB_DE[] = {
'd','o','l','n','o','s','e','r','b',0xC5,0xA1,0xC4,0x87,'i','n','a',0x00,
};
static signed char *CALENDAR_LLSC_NATIVE_IN_DSB_DE = (CALENDAR_NATIVE_IN_DSB_DE);
...
static signed char MAR_DSB_DE[] = {
'm',0xC4,0x9B,'r','.',0x00,
};
static signed char *(CALENDAR_MON_IN_DSB_DE[]) = {
"",
"jan.",
"feb.",
MAR_DSB_DE,
