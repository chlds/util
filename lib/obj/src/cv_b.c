...
Convert to the (unsigned or) signed byte.
...
signed int(__cdecl cv_b(signed short(radix), signed char(*di), signed char(*base))) {

/* **** DATA, BSS and STACK */
static signed char(d) = (0x00);
