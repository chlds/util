...
Convert to the (unsigned or) signed word.
...
signed int(__cdecl cv_w(signed short(radix), signed short(*di), signed char(*base))) {

/* **** DATA, BSS and STACK */
static signed short(d) = (0x00);
