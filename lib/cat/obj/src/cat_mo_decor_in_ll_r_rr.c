...
cat_january_decor_in_ll,
cat_february_decor_in_ll,
cat_march_decor_in_ll,
cat_april_decor_in_ll,
cat_may_decor_in_ll,
cat_june_decor_in_ll,
cat_july_decor_in_ll,
cat_august_decor_in_ll,
cat_september_decor_in_ll,
cat_october_decor_in_ll,
cat_november_decor_in_ll,
cat_december_decor_in_ll,
0x00,
};
b = (0x00);
if(!argp) return(b);
