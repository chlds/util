...
if(r<(nonae)) b = cat_xe(b,cat_word_separator(),cat_non(deco),(void*)(0x00));
if(EQ(r,nonae+(~0x00))) return(b);
if(r<(nonae)) return(cat_xe(cat_ante_abbrev(deco),cat_word_separator(),cat_diem_abbrev(deco),cat_word_separator(),b,(void*)(0x00)));
b = cat_xe(b,cat_word_separator(),cat_eid(deco),(void*)(0x00));
if(EQ(r,idus+(~0x00))) return(b);
return(cat_xe(cat_ante_abbrev(deco),cat_word_separator(),cat_diem_abbrev(deco),cat_word_separator(),b,(void*)(0x00)));
}
