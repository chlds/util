...
signed char **(__cdecl daterangequarterly_xe(signed(argt),signed(args),time_t(argp)));
...
signed char *(__cdecl collapseddaterange_xe(signed(argt),signed(args),time_t(argp)));
...
signed char *(__cdecl wcfriday(signed(args),time_t(argp)));
signed char *(__cdecl wcthursday(signed(args),time_t(argp)));
signed char *(__cdecl wcwednesday(signed(args),time_t(argp)));
signed char *(__cdecl wctuesday(signed(args),time_t(argp)));
signed char *(__cdecl wcmonday(signed(args),time_t(argp)));
signed char *(__cdecl wcsunday(signed(args),time_t(argp)));
...
signed char *(__cdecl calendarweek_xe(time_t(argt),signed(args),signed(argp)));
signed char *(__cdecl calendarweek(signed(argt),signed(args),time_t(argp)));
...
signed char *(__cdecl wednesdayweekdate(signed(args),time_t(argp)));
...
signed(__cdecl fridayweeknumber(signed(args),time_t(argp)));
signed(__cdecl thursdayweeknumber(signed(args),time_t(argp)));
signed(__cdecl wednesdayweeknumber(signed(args),time_t(argp)));
signed(__cdecl tuesdayweeknumber(signed(args),time_t(argp)));
...
signed(__cdecl currentweeknumber(signed(argt),signed(args),time_t(argp)));
signed(__cdecl currentweeknumber_xe(time_t(argt),signed(args),signed(argp)));
time_t(__cdecl lastcalendarweeksaturday(signed(args),time_t(argp)));
time_t(__cdecl lastcalendarweekfriday(signed(args),time_t(argp)));
time_t(__cdecl lastcalendarweekthursday(signed(args),time_t(argp)));
time_t(__cdecl lastcalendarweekwednesday(signed(args),time_t(argp)));
time_t(__cdecl lastcalendarweektuesday(signed(args),time_t(argp)));
...
time_t(__cdecl finalweek_xe(time_t(argt),signed(args),signed(argp)));
time_t(__cdecl initialweek_xe(time_t(argt),signed(args),signed(argp)));
time_t(__cdecl initialweek(signed(argt),signed(args),time_t(argp)));
...
time_t(__cdecl tuesdayweeknumberone(signed(args),time_t(argp)));
time_t(__cdecl wednesdayweeknumberone(signed(args),time_t(argp)));
time_t(__cdecl thursdayweeknumberone(signed(args),time_t(argp)));
...
time_t(__cdecl latestweek(signed(argt),signed(args),time_t(argp)));
time_t(__cdecl latestweek_xe(time_t(argt),signed(args),signed(argp)));
time_t(__cdecl earliestweek_xe(time_t(argt),signed(args),signed(argp)));
time_t(__cdecl earliestweek(signed(argt),signed(args),time_t(argp)));
...
signed char *(__cdecl cat_yr_decor_in_ll(signed(arg)));
...
signed char *(__cdecl map_week_number_xe_rr(signed(args),time_t(*argp)));
signed char *(__cdecl map_week_number_xe_r(signed(args),time_t(*argp)));
signed char *(__cdecl map_week_number_xe(signed(args),time_t(*argp)));
