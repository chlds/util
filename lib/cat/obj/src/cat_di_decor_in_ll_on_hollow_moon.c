...
if(!(0x01+(r))) return(b);
if(idus<(r)) return(cat_di_decor_in_ll_on_new_moon(argp));
...
if(r<(nonae)) b = cat_xe(b,cat_word_separator(0x01),cat_nonas(deco),(void*)(0x00));
if(EQ(r,nonae+(~0x00))) return(b);
if(r<(nonae)) return(cat_xe(cat_ante(deco),cat_word_separator(0x01),cat_diem(deco),cat_word_separator(0x01),b,(void*)(0x00)));
b = cat_xe(b,cat_word_separator(0x01),cat_idvs(deco),(void*)(0x00));
if(EQ(r,idus+(~0x00))) return(b);
return(cat_xe(cat_ante(deco),cat_word_separator(0x01),cat_diem(deco),cat_word_separator(0x01),b,(void*)(0x00)));
}
